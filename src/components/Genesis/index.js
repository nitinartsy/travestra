  ...
  return (
    ...
    /> */}
              ...
              <p ref={descriptionRef} className={styles.heroDescription}>
                Tavastra is not just another accelerator; it's a modern-day gurukul, a sanctuary for founders where ideas transform <br /> into reality. The name "Tavastra" is rooted in ancient Sanskrit, signifying a divine craftsman, a builder, and an innovator. This reflects our core belief in nurturing and empowering founders to craft groundbreaking <br /> companies.
              </p>
            </div>
          </div>
        ...
        <div className={styles.container1st}>
          <div>
            <div className={styles.heading}>
              <h1>The Genesis of Tavastra</h1>
            </div>

          </div>
        </div>
        <div className={styles.container_one_sub}>
          <div className={styles.paragraph1}>
            <p>
              Tavastra was born from the vision of Ritesh Mohan Srivastava, a seasoned data scientist and serial investor. Having served as Chief Data Scientist at renowned companies like BharatPe, Novartis, Yatra, CarDekho, and Lowe's, Ritesh has traversed continents, spending over 15 years leading data-driven initiatives and guiding companies to unicorn status.
            </p>
            <p className={styles.prgph2}>His journey into angel investing unveiled critical gaps in the startup ecosystem:</p>
          </div>
          <div className={styles.container1st_img}>
            <img src="/heroImage.sv" alt="Tavastra" />
          </div>
        </div>
        <div className={styles.container2nd}>


          <div className={`mt-40 ${styles.container2ndParagraph1}`}>
            <div className={styles.PCount}>
              <p>01</p>
            </div>
            <div >
              <p>The Need for a Reimagined Angel Role:</p>
              <p className='mt-40'>Ritesh recognized that traditional angel investors often lacked the hands-on involvement and comprehensive support that founders truly needed to thrive.</p>
            </div>
          </div>
          ...
          <div className={`mt-40 ${styles.container2ndParagraph1}`}>
            ...
            <div >
              <p>Bridging the Gap from Idea to MVP:</p>

              <p>He observed that the process of building an MVP was often fraught with delays, complexities, and a lack of readily available expertise, hindering a startup's momentum.</p>
            </div>
          </div>


          <div className={`mt-40 ${styles.finalText}`}>
            <p><strong>Driven by these insights, Ritesh founded Tavastra to address these challenges and redefine the role of an angel investor.</strong></p>
          </div>
